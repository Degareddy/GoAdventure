...
export class TenantSearchComponent implements OnInit, OnDestroy {
  ...
  columnDefs: any = [
    { field: "partyName", headerName: "Name", sortable: true, filter: true, resizable: true },
    { field: "phones", headerName: "Mobile", sortable: true, filter: true, resizable: true },
  ...
  ngOnInit(): void {
    this.SearchPartyForm.get('clientType')!.setValue(this.data.clientType);
